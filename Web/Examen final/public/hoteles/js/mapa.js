...
// let cc = listaHoteles['coordenadas'];
// console.log(cc);
cambiar();
function cambiar(){ document.querySelector('#provincias').value = "2";
}
            ...
            var map;
            var geocoder;
            /*al mostrar la ubicacion del mapa, se obtienen las coordenadas
            registradas (LOCALMENTE) y se cambian por estas variables */
            var crLat = 9.6301892;
